...
const OfferPage = () => {
  ...
  const offerProducts = useMemo(() => {
    return products.filter(p => p.isOffer === true);
  }, [products]);
  ...
  const totalDiscount = useMemo(() => {
    return offerProducts.reduce((total, product) => {
      return total + ((product.originalPrice - product.price) * product.reviews || 0);
    }, 0);
  }, [offerProducts]);
  ...
  return (
    <div className="bg-gray-50 py-8 min-h-screen">
      <div className="container mx-auto px-4">
        {/* Breadcrumb */}
        <Breadcrumb page="Offer" className="py-2" />
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/90 mt-1">Don't miss out on these amazing deals!</p>
              </div>
            </div>
            <div className="bg-white/20 px-4 py-2 rounded-full">
              <div className="flex items-center gap-2">
                <Sparkles className="w-4 h-4" />
                <span className="font-semibold">{offerProducts.length} Products on Sale</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
              ...
              <div className="flex justify-between items-center flex-wrap gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Showing {currentProducts.length} of {sortedProducts.length} offer products
                  </p>
                </div>
            ...
            <div className="bg-white rounded-lg p-4 mb-6 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="text-sm text-gray-600">
                <span className="font-semibold">{sortedProducts.length}</span> offer products found
              </div>
