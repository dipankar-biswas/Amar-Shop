...
export const Navbar = () => {
  ...
  return (
    <nav className="relative border-y border-gray-200 bg-[#f3f3f3]">
      <div className="mx-auto flex w-full max-w-[1240px] items-center gap-8 px-4 py-3 text-sm text-gray-700">
        <div
              ...
              <div className="grid grid-cols-[240px_1fr]">
                ...
                <div className="grid grid-cols-3 gap-x-10 gap-y-6 p-7">
                  {activeMegaContent.groups.map((group) => (
                    <div key={group.title}>
                      <Link href={`/categories?category=${encodeURIComponent(group.title)}`} className="mb-2 text-[17px] font-semibold text-gray-800">
                        {group.title}
                      </Link>
