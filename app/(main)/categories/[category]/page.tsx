...
const CategoryWisePage = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    priceRange: { min: 0, max: 2000 } as { min: number; max: number },
            ...
            <div className="bg-white rounded-lg p-4 mb-6 shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="bg-white rounded-lg">
                <h1 className="text-xl md:text-2xl font-semibold text-gray-800">
                  {formatCategoryName()} Products
                </h1>
                <p className="mt-2 text-sm text-gray-500">
                  Showing {currentProducts.length} of {sortedProducts.length}{" "}
                  products
                  {category && ` in ${formatCategoryName()} category`}
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-12 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    {category
                      ? `No products found in ${formatCategoryName()} category`
