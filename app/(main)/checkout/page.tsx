...
const CheckoutPage = () => {
  ...
  return (
    <div className="bg-[#f3f3f3] py-8">
      <div className="mx-auto grid w-full max-w-[1240px] grid-cols-1 gap-6 px-4 lg:grid-cols-[1fr_430px]">
        <section className="rounded border border-gray-300 bg-white p-4">
          <h1 className="text-4xl text-[44px] font-semibold">Checkout</h1>
        ...
        <section className="rounded border border-gray-300 bg-white p-4">
          <h2 className="text-3xl text-[36px] font-semibold">Your order</h2>
          ...
          <p className="mt-3 text-lg font-semibold">Total: <span className="text-[#ef553f]">{taka(subtotal)}</span></p>
          <button className="mt-5 w-full rounded bg-[#ef553f] py-3 font-semibold text-white">Place Order</button>
        </section>
      </div>
    </div>
  );
